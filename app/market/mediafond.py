...
def mediafond(ticker: str, start_date: str | None = None, end_date: str | None = None) -> list:
    """
    Fetches historical market data for a given ticker symbol from MEDIAFOND API.
    ...
    headers = {
        ...
        'Referer': 'https://www.mediafond.it',
